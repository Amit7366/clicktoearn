...
import ReplyMessageModal from "./ReplyModal";
            ...
            {filteredMessages.map((msg, idx) => (
              <tr key={idx}>
                ...
                <td className="px-4 py-3 text-gray-400">
                  {format(msg.date, "dd MMM yyyy")}
                </td>
                <td className="px-4 py-3">
                   <button
                   onClick={() =>
                      setReplyTo({ email: msg.email, subject: msg.subject })
                    }
                    className="bg-blue-50 text-blue-600 py-2 rounded flex justify-center items-center gap-2 px-4"
                  >
                    <span>Reply</span> <Edit className="w-4 h-4" /> 
                  </button>
